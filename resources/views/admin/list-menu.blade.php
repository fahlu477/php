    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#tblEditavel tbody tr td.editavelSelect').dblclick(function() {
                ...
                Elm.append($('<option/>', { value: '2', text : 'Tidak Siap' } ));
                $(this).html(Elm.bind('blur keydown', function(e) {
                    var keyCode = e.which;
                    var values = $(this).val();
                    var texts = ( values == 1 ? 'Siap' );
                    var texts = ( values == 2 ? 'Tidak Siap');
                    var idmenu = $(this).parents('tr').children().first().text();
                    if (keyCode == 13 || keyCode == 0 && values != '' && values != valuesOriginal) {
                        var objeto = $(this);
                        $.ajaxSetup({
        ...
        <div class="col-md-8">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <table id="tblEditavel" class="table table-hover  table-responsive-sm" data-toggle="tooltip" title="{{ ( Auth::user()->level == 1 ? 'Double klik untuk Edit' : '' ) }}">
                        <thead>
                            <tr>
                                <td>ID</td>
                                <td width="40%">Nama</td>
